...
extern "C" u8* _EWRAM_OVERLAY_SECTION_ROM_START(num); \
...
extern "C" u8* _IWRAM_OVERLAY_SECTION_ROM_START(num); \
...
#define _BSS_OVERLAY_SECTION_SIZE(num) \
	PPCAT(_BSS_OVERLAY_PREFIX(num),_section_size)
...
#define _IWRAM_BSS_OVERLAY_SECTION_SIZE(num) \
	PPCAT(_IWRAM_BSS_OVERLAY_PREFIX(num),_section_size)
...
#define _SRAM_OVERLAY_SECTION_SIZE(num) \
	PPCAT(_SRAM_OVERLAY_PREFIX(num),_section_size)
...
#define _EWRAM_CODE_OVERLAY_SECTION_ROM_START(num) \
	PPCAT(_EWRAM_CODE_OVERLAY_PREFIX(num),_rom_start)
#define _EWRAM_CODE_OVERLAY_SECTION_EWRAM_START(num) \
	PPCAT(_EWRAM_CODE_OVERLAY_PREFIX(num),_ewram_start)
#define _EWRAM_CODE_OVERLAY_SECTION_SIZE(num) \
	PPCAT(_EWRAM_CODE_OVERLAY_PREFIX(num),_section_size)

#define _EXPOSE_EWRAM_CODE_OVERLAY(num) \
extern "C" u8* _EWRAM_CODE_OVERLAY_SECTION_ROM_START(num); \
...
#define _IWRAM_CODE_OVERLAY_SECTION_ROM_START(num) \
	PPCAT(_IWRAM_CODE_OVERLAY_PREFIX(num),_rom_start)
#define _IWRAM_CODE_OVERLAY_SECTION_IWRAM_START(num) \
	PPCAT(_IWRAM_CODE_OVERLAY_PREFIX(num),_iwram_start)
#define _IWRAM_CODE_OVERLAY_SECTION_SIZE(num) \
	PPCAT(_IWRAM_CODE_OVERLAY_PREFIX(num),_section_size)

#define _EXPOSE_IWRAM_CODE_OVERLAY(num) \
extern "C" u8* _IWRAM_CODE_OVERLAY_SECTION_ROM_START(num); \
...
#define TITLE_SCREEN_EWRAM_SECTION_EWRAM_START \
...
#define TITLE_SCREEN_IWRAM_SECTION_IWRAM_START \
...
#define OVERWORLD_LOAD_EWRAM_SECTION_EWRAM_START \
...
#define OVERWORLD_LOAD_IWRAM_SECTION_IWRAM_START \
...
#define OVERWORLD_EWRAM_SECTION_EWRAM_START \
...
#define OVERWORLD_IWRAM_SECTION_IWRAM_START \
...
#define LEVEL_LOAD_EWRAM_SECTION_EWRAM_START \
...
#define LEVEL_LOAD_IWRAM_SECTION_IWRAM_START \
...
#define LEVEL_EWRAM_SECTION_EWRAM_START \
...
#define LEVEL_IWRAM_SECTION_IWRAM_START \
