...
u32 (& curr_index_arr)[curr_index_arr_size]
	= DebugArrGroup::the_raw_array_group.curr_index_arr;
u32 (& debug_u32_arr)[debug_u32_arr_size]
	= DebugArrGroup::the_raw_array_group.debug_u32_arr;
s32 (& debug_s32_arr)[debug_s32_arr_size]
	= DebugArrGroup::the_raw_array_group.debug_s32_arr;
Fixed24p8 (& debug_f24p8_arr)[debug_f24p8_arr_size]
	= DebugArrGroup::the_raw_array_group.debug_f24p8_arr;
Fixed8p8 (& debug_f8p8_arr)[debug_f8p8_arr_size]
	= DebugArrGroup::the_raw_array_group.debug_f8p8_arr;
DebugStr (& debug_str_arr)[debug_str_arr_size]
	= DebugArrGroup::the_raw_array_group.debug_str_arr;
...
ArrayHelper<DebugStr> DebugArrGroup::debug_str_arr_helper
