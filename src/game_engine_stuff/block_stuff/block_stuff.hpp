...
inline bool bt_is_slope( block_type the_block_type )
{
	...
	return bbvt_is_slope(get_behavior_type_of_block_type(the_block_type));
}

// bbvt_is_left_slope() goes in IWRAM so that a jump table can be generated
...
{
	return bbvt_is_left_slope(get_behavior_type_of_block_type
		(the_block_type));
}


// bbvt_is_right_slope() goes in IWRAM so that a jump table can be
...
{
	return bbvt_is_right_slope(get_behavior_type_of_block_type
		(the_block_type));
}
...
inline bool bt_is_neither_air_nor_left_slope( block_type the_block_type )
{
	...
	return bbvt_is_neither_air_nor_left_slope
		(get_behavior_type_of_block_type(the_block_type));
}
...
inline bool bt_is_neither_air_nor_right_slope( block_type the_block_type )
{
	...
	return bbvt_is_neither_air_nor_right_slope
		(get_behavior_type_of_block_type(the_block_type));
}
