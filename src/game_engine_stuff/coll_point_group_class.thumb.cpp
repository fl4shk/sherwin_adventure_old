...
#include "sprite_stuff/sprite_base_class.hpp"
...
void generate_coll_point_group_16x16( const sprite_base& the_sprite_base, 
	coll_point_group& the_pt_group )
{
	const coll_box& the_coll_box = the_sprite_base.the_coll_box;
	...
	//
	////pt_bl.y = pt_bm.y = pt_br.y = the_coll_box.bot() 
	////	+ the_sprite_base.cb_pos_offset.y;
	////pt_bl.y = pt_bm.y = pt_br.y = the_coll_box.bot() + make_f24p8(2);
	//
	////pt_bl.y = pt_bm.y = pt_br.y = the_sprite_base.in_level_pos.y 
	////	+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y + 2 );
	//
	////pt_bl.y = pt_bm.y = pt_br.y = the_sprite_base.in_level_pos.y 
	////	+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y );
	...
	else //if (!the_sprite_base.on_ground)
	{
		list_of_16x16_bottom_side_coll_point_names(X)
			the_coll_box.bot();
	}
	...
	//	the_coll_box.bot() + (fixed24p8){0x200};
		...
		//the_sprite_base.in_level_pos.y 
		//+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y + 2 );
		////the_sprite_base.in_level_pos.y 
		////+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y + 1 );
	#undef X
	...
	coll_point_group& the_pt_group )
{
	...
	//	the_coll_box.bot() + (fixed24p8){0x200};
		...
		//+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y + 2 );
		////the_sprite_base.in_level_pos.y 
		////+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y + 8 );
		////the_sprite_base.in_level_pos.y 
		////+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y + 1 );
		////the_sprite_base.in_level_pos.y 
		////+ make_f24p8( the_sprite_base.get_shape_size_as_vec2().y );
