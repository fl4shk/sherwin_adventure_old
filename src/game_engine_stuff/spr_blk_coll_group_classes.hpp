...
protected:		// variables and constants
	...
	vert_bot_coll_tuple vert_bot_ctups[num_vert_bot_ctups];
...
public:		// functions
	...
	virtual const size_t get_num_horiz_ctups() const;
	virtual const size_t get_num_vert_top_ctups() const;
	//virtual const size_t get_num_vert_bot_ctups() const;
	static inline constexpr size_t get_num_vert_bot_ctups()
	{
		return num_vert_bot_ctups;
	}
	
	virtual const size_t get_hi_left_top() const;
	virtual const size_t get_hi_left_bot() const;
	virtual const size_t get_hi_right_top() const;
	virtual const size_t get_hi_right_bot() const;
	
	virtual const size_t get_vi_top_left() const;
	virtual const size_t get_vi_top_right() const;
...
// Collision Line Segment Group for collision boxes that are at most 16x16
// in size
...
protected:		// variables and constants
	static constexpr size_t num_horiz_ctups = lim_hi,
		num_vert_top_ctups = lim_vi_top;
	
	horiz_coll_tuple horiz_ctups_arr[num_horiz_ctups];
	vert_top_coll_tuple vert_top_ctups_arr[num_vert_top_ctups];
...
protected:		// variables and constants
	...
	horiz_coll_tuple horiz_ctups_arr[num_horiz_ctups];
	vert_top_coll_tuple vert_top_ctups_arr[num_vert_top_ctups];
	//vert_bot_coll_tuple vert_bot_ctups_arr[num_vert_bot_ctups];
