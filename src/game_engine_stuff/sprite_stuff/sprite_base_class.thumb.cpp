...
const oam_entry::shape_size sprite_base::the_initial_shape_size 
	= oam_entry::ss_16x16;

const vec2_f24p8 sprite_base::the_initial_coll_box_size
	= { {14 << fixed24p8::shift}, {14 << fixed24p8::shift} },
	sprite_base::the_initial_cb_pos_offset 
	= { {1 << fixed24p8::shift}, {1 << fixed24p8::shift} };

const vec2_f24p8 sprite_base::the_initial_in_level_pos_offset
...
sprite_base::sprite_base()
{
	...
	memfill32( this, 0, sizeof(*this) / sizeof(u32) );
...
//sprite_base::sprite_base( u32 s_vram_chunk_index, 
...
//			init(!the_sprite_ipg->facing_right);
//			
...
void sprite_base::reinit_with_sprite_ipg
	( sprite_init_param_group* s_the_sprite_ipg )
{
	u32 old_vram_chunk_index = vram_chunk_index;
...
void sprite_base::reinit_with_sprite_ipg( u32 s_vram_chunk_index,
	sprite_init_param_group* s_the_sprite_ipg )
{
	switch ( s_the_sprite_ipg->spawn_state )
	{
...
void sprite_base::update_on_screen_pos( const bg_point& camera_pos )
{
...
void sprite_base::camera_follow_basic( bg_point& camera_pos )
{
	vec2_f24p8 temp_on_screen_pos = get_on_screen_pos(camera_pos);
...
void sprite_base::center_camera_almost( bg_point& camera_pos ) const
{
...
vec2_u32 sprite_base::get_shape_size_as_vec2_raw() const
{
...
void sprite_base::init( bool facing_left )
{
	...
	set_initial_shape_size_of_sprite();
	set_initial_coll_box_stuff_of_sprite();
...
void sprite_base::init( const vec2_f24p8& s_in_level_pos, 
...
const sprite_type sprite_base::get_sprite_type() const
{
	return st_default;
}

void sprite_base::set_initial_shape_size_of_sprite()
{
	set_shape_size(get_the_initial_shape_size());
}

void sprite_base::set_initial_coll_box_stuff_of_sprite()
{
...
void sprite_base::gfx_update()
{
	//the_oam_entry.set_tile_number(get_curr_tile_slot_old());
...
void sprite_base::update_part_1()
{
...
void sprite_base::update_part_2( bg_point& camera_pos, 
	const vec2_u32& the_level_size_2d )
{
}


void sprite_base::update_part_2( const bg_point& camera_pos, 
	int& next_oam_index )
{
	gfx_update();
...
//const u32 sprite_base::get_curr_tile_slot_old()
//{
//	return 
...
const u32 sprite_base::get_curr_tile_slot()
{
	return get_vram_chunk_index() * gfx_manager::num_tiles_in_ss_32x32;
}
...
const sprite_palette_slot sprite_base::get_palette_slot()
{
	return the_palette_slot;
}
const u32 sprite_base::get_curr_relative_tile_slot()
{
...
void sprite_base::block_collision_stuff()
{
}
...
// player_sprite_stuff).
void sprite_base::handle_jumping_stuff( u32 is_jump_key_hit, 
...
void sprite_base::get_basic_block_coll_results_16x16
...
void sprite_base::get_basic_block_coll_results_16x32
...
// 16x16 sprites
void sprite_base::block_coll_response_left_16x16
	( const block_coll_result& lt_coll_result,
	const block_coll_result& lb_coll_result )
{
	in_level_pos.x = make_f24p8( ( lt_coll_result.coord.x + 1 )
		* 16 ) - cb_pos_offset.x;
...
void sprite_base::block_coll_response_right_16x16
...
void sprite_base::non_slope_block_coll_response_bot_16x16
	...
	const block_coll_result& br_coll_result )
{
	...
	{
		in_level_pos.y = make_f24p8( bl_coll_result.coord.y 
			* 16 ) 
			//- ( the_coll_box.size.y +
			//cb_pos_offset.y );
			- make_f24p8(get_shape_size_as_vec2().y);
...
//block_type sprite_base::slope_block_coll_response_bot_16x16
//	( coll_point_group& the_pt_group,
...
// 16x32 sprites
void sprite_base::block_coll_response_left_16x32
	( const block_coll_result& lt_coll_result,
...
void sprite_base::block_coll_response_top_16x32
	( const block_coll_result& tl_coll_result,
	const block_coll_result& tm_coll_result, 
	const block_coll_result& tr_coll_result )
{
...
void sprite_base::block_coll_response_right_16x32
	( const block_coll_result& rt_coll_result,
...
void sprite_base::non_slope_block_coll_response_bot_16x32
	( const block_coll_result& bl_coll_result,
	const block_coll_result& bm_coll_result, 
	const block_coll_result& br_coll_result )
{
...
block_type sprite_base::slope_block_coll_response_bot_16x32
	( coll_point_group& the_pt_group, block_coll_result& bl_coll_result, 
	block_coll_result& bm_coll_result, block_coll_result& br_coll_result, 
	bool hitting_tltr )
{
...
void sprite_base::apply_gravity()
{
	vel.y += grav_acc;
...
void sprite_base::sprite_interaction_reponse( sprite& the_other_sprite )
{
...
void sprite_base::block_collision_stuff_16x16()
{
	...
	//show_debug_str_s32( *this.on_ground ? "ongn" : "offg" );
...
void sprite_base::block_collision_stuff_16x32()
{
	// The collision points
	coll_point_group the_pt_group;
...
void sprite_base::block_collision_stuff_32x16()
{
	
}
void sprite_base::block_collision_stuff_32x32()
{
...
void sprite_base::block_collision_stuff_strongly_hit_stuff_only_16x16()
{
	// The collision points
	coll_point_group the_pt_group;
...
void sprite_base::block_collision_stuff_strongly_hit_stuff_only_16x32()
{
	// The collision points
	coll_point_group the_pt_group;
...
void sprite_base::block_collision_stuff_strongly_hit_stuff_only_32x16()
{
	
}

void sprite_base::block_collision_stuff_strongly_hit_stuff_only_32x32()
{
