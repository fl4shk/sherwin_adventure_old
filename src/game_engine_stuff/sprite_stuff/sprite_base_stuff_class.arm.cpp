...
void sprite_base_stuff::get_block_coll_results_left_16x16
...
void sprite_base_stuff::get_block_coll_results_top_16x16
...
void sprite_base_stuff::get_block_coll_results_right_16x16
...
void sprite_base_stuff::get_block_coll_results_bot_16x16
...
void sprite_base_stuff::get_block_coll_results_left_16x32
	( coll_point_group& the_pt_group, block_coll_result& lt_coll_result, 
...
void sprite_base_stuff::get_block_coll_results_top_16x32
	( coll_point_group& the_pt_group, block_coll_result& tl_coll_result, 
	block_coll_result& tm_coll_result, block_coll_result& tr_coll_result )
{
	// DON'T change this function unless in the future a 16x32 hitbox uses
...
void sprite_base_stuff::get_block_coll_results_right_16x32
	( coll_point_group& the_pt_group, block_coll_result& rt_coll_result,
...
void sprite_base_stuff::get_block_coll_results_bot_16x32
	( coll_point_group& the_pt_group, block_coll_result& bl_coll_result, 
	block_coll_result& bm_coll_result, block_coll_result& br_coll_result )
{
	// DON'T change this function unless in the future a 16x32 hitbox uses
...
void sprite_base_stuff::block_coll_response_left_16x16
	( sprite& the_sprite, const block_coll_result& lt_coll_result,
	const block_coll_result& lb_coll_result )
{
	the_sprite.in_level_pos.x 
		= make_f24p8( ( lt_coll_result.coord.x + 1 ) * 16 )
		- the_sprite.cb_pos_offset.x;
	
}
void sprite_base_stuff::block_coll_response_top_16x16
	( sprite& the_sprite, const block_coll_result& tl_coll_result,
...
void sprite_base_stuff::block_coll_response_bot_16x16
...
void sprite_base_stuff::block_coll_response_left_16x32
	( sprite& the_sprite, const block_coll_result& lt_coll_result,
...
void sprite_base_stuff::block_coll_response_top_16x32
	( sprite& the_sprite, const block_coll_result& tl_coll_result,
	const block_coll_result& tm_coll_result, 
	const block_coll_result& tr_coll_result )
{
...
void sprite_base_stuff::block_coll_response_bot_16x32
	( sprite& the_sprite, const block_coll_result& bl_coll_result,
	const block_coll_result& bm_coll_result, 
	const block_coll_result& br_coll_result )
{
	block_coll_response_bot_16x16( the_sprite, bl_coll_result, 
...
void sprite_base_stuff::block_collision_stuff_16x16( sprite& the_sprite )
{
	...
	get_block_coll_results_left_16x16( the_pt_group, lt_coll_result,
		lb_coll_result );
	get_block_coll_results_right_16x16( the_pt_group, rt_coll_result,
		rb_coll_result );
	
	get_block_coll_results_top_16x16( the_pt_group, tl_coll_result,
		tm_coll_result, tr_coll_result );
	get_block_coll_results_bot_16x16( the_pt_group, bl_coll_result,
		bm_coll_result, br_coll_result );
...
void sprite_base_stuff::block_collision_stuff_16x32( sprite& the_sprite )
{
	...
	get_block_coll_results_left_16x32( the_pt_group, lt_coll_result,
		lm_coll_result, lb_coll_result );
	get_block_coll_results_right_16x32( the_pt_group, rt_coll_result,
		rm_coll_result, rb_coll_result );
	
	get_block_coll_results_top_16x32( the_pt_group, tl_coll_result,
		tm_coll_result, tr_coll_result );
	get_block_coll_results_bot_16x32( the_pt_group, bl_coll_result,
		bm_coll_result, br_coll_result );
	...
	auto any_bot_response = [&]() -> void
	{
		block_coll_response_bot_16x32( the_sprite, bl_coll_result,
			bm_coll_result, br_coll_result );
	};
