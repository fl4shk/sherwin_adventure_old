...
#ifndef sprite_base_class_hpp
#define sprite_base_class_hpp
...
public:		// functions from the old sprite class
	
	sprite_base();
	inline sprite_base( u32 s_vram_chunk_index )
	{
		sprite_base();
		...
		bool facing_left=true )
	{
		...
		init( s_in_level_pos, camera_pos, facing_left );
...
protected:		// functions from the old sprite class
	vec2_u32 get_shape_size_as_vec2_raw() const
		__attribute__((_iwram_code));
	
public:		// functions from the old sprite_base_stuff class
	
	// This is the default form of init().
	virtual void init( bool facing_left=true );
	
	// This form of init() might eventually become the default form of
	// init().
	virtual void init( const vec2_f24p8& s_in_level_pos, 
	...
	virtual void set_initial_shape_size_of_sprite();
	...
	virtual void set_initial_coll_box_stuff_of_sprite();
...
protected:		// functions from the old sprite_base_stuff class
