...
LD_FLAGS=--specs=nosys.specs $(EXTRA_LD_FLAGS) -L./maxmod/lib -T $(LD_SCRIPT) -Wl,--entry=_start2 `arm-none-eabi-gcc -print-file-name=thumb/libgcc.a` `arm-none-eabi-gcc -print-file-name=thumb/libc.a` `arm-none-eabi-gcc -print-file-name=thumb/libstdc++.a` -lgcc -lc -lstdc++ -lmm $(DEBUG_FLAGS)
